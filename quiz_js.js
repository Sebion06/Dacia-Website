...
alert("Nu ai răspuns la toate întrebările!");        
}        
...
var cat11 = ($("input[@name=q11]:checked").val() != "d"); 
...
var cat17 = (!cat1 && !cat2 && !cat3 && !cat4 && !cat5 && !cat6 && !cat7 && !cat8 && !cat9 && !cat10 && !cat11 && !cat12 && !cat13 && !cat14 && !cat15 && !cat16); var categories = [];                        
...
var catStr = 'Ai răspuns greșit la următoarele întrebări: ' + categories.join(', ') + '';                     
